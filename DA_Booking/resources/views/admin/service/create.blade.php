...
<!-- Begin Page Content -->
    @if(Session::has('erro'))
        ...
        @endif
    {{Form::open(['url'=>'admin/service', 'method'=>'post'])}}
    <div class="container">
        ...
        <div class="form-group">
            ...
            {{Form::text('decription','',['class'=>'form-control'])}}
        </div>

        <div class="form-group">
            {{Form::submit('Save',['class'=>'btn btn-outline-info '])}}
            <a href="{{route('service.index')}}" class="btn btn-outline-dark"><i class="fas fa-undo-alt"></i></a>
        </div>
    </div>
    {{Form::close()}}
    <!-- /.container-fluid -->
