...
<script type="text/javascript">
	...
	//tạo biến hứng dữ liệu sau khi scanner từ video (id:preview) bằng cách new Instascan.Scanner
	...
	//Thực hiện bật camera, webcame máy tính bằng Instascan JS một trình quét mã QR HTML5
