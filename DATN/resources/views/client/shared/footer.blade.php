        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7 footer-widget ftr-map">
                    <div class="map">
                        <iframe src="https://www.google.com/maps/embed/v1/place?key=AIzaSyAPrSkaBK4HPR-vFfJ-farhnl7sYPdWBb8%20&q=Trường+Đại+học+Đông+Á,Da%20Nang,%20Viet%20Nam%22" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6" id="copyright">
                    <p>© 2020 {{trans('allclient.copy_right')}} ELA HOTEL. </p>
                </div>
